                ...
                ScrollView(.horizontal, showsIndicators: false) {
                    VStack(spacing:3) {
                        ...
                        HStack(alignment: .bottom, spacing: 30) {
                            ...
                            PopupPrompts(image: SFElement(imageName: "bus.fill", width: 75, height: 75), promptText: "Where to?", promptImage1: SFElement(imageName: "house.fill", width: 50, height: 40), showOptions: $showTravelOptions)
